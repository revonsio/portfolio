...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Theodorus Revonsio</title>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <div class="title m-b-md">
                    5026201045<br>
                    Theodorus Revonsio Prananta 
                </div>

                <div class="links">
                    <a href="Theodorus Revonsio Prananta_5026201045_PWEB D/profil_revo.html">Tugas 1</a>
                    <a href="THEODORUS REVONSIO PRANANTA_5026201045_PWEB_CSS/index.html">Tugas 2</a>
